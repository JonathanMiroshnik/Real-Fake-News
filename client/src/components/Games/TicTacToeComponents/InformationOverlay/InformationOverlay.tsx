        ...
        <div className="information-overlay">
            ...
            <div className="information-content">
                <div className="text-center">                                  
                    ...
                    <div>
                        <button onClick={nextPage} style={{visibility: index + 1 < BOARDS.length ? 'visible': 'hidden'}} className="information-page-move-button">
                            Next
                        </button>
                        <button onClick={previousPage} style={{visibility: index > 0 ? 'visible': 'hidden'}} className="information-page-move-button">
                            Previous
                        </button>
                    </div>
