    ...
    <div className="w-full mb-4 md:mb-3">
      <div className="flex items-center mb-2 md:mb-1 pb-3">
        <div className="flex flex-col gap-[0.1rem]">
          <div
            className="text-(--title-color) text-[0.8rem] font-medium 
                          uppercase tracking-[0.3px] md:text-[0.75rem]"
          >
            {topLine}
          </div>
          <div
            className="text-(--description-color) text-[0.7rem] font-normal 
                          opacity-70 md:text-[0.65rem]"
          >
            {bottomLine}
          </div>
        </div>
