...
function Footer() {
  ...
  return (
    <footer
      className={`pb-8 border-t border-[#cc0000] text-center ${
    ...
    >
      ...
      <p className={`${darkMode ? 'text-black' : 'text-white'} text-sm`}>
        © 2025 Real Fake News - Satirical AI-generated content.
      </p>
      <p className={`${darkMode ? 'text-black' : 'text-white'} text-sm`}>
        All rights reserved. Real Fake News is not responsible for the content of external sites.
      </p>
      <a
        href="https://github.com/JonathanMiroshnik/Real-Fake-News"
        className={`no-underline 
