...
async function writeFeaturedPost(writers: Writer[], currentNewsItem: NewsItem = { title: "", description: "" }) {

}

async function writeBlogPost(writer: Writer, currentNewsItem: NewsItem = { title: "", description: "" }, saveArticle: boolean = true) {
...
async function createFeaturedArticle(writers: Writer[], currentNewsItem: NewsItem = { title: "", description: "" }, prompt: string) {
    ...
    return await createPost<FeaturedArticleScheme>(newFeaturedArticle, DB_FEATURED_BLOG_POST_FILE)
}
